...
typedef Std_ReturnType (*DemDataElementReadFnc_cb)(uint8* Buffer);
...
typedef struct
{
    ...
    uint8 DemDidDataElementClassRef_type ;
    DemDataElementClass_s* DemDidDataElementClassRef_ptr;
    uint8 DemDidDataElementClassRef_numberOfElements;
}DemDidClass_s;
