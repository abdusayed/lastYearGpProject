...
typedef uint8   readDtcSubFunction;
#define REPORT_NUMBER_OF_DTC_BY_STATUS_MASK_0x01                        ((readDtcSubFunction)0x01)
#define REPORT_DTC_BY_STATUS_MASK_0x02                                  ((readDtcSubFunction)0x02)
#define REPORT_MIRROR_MEMORY_DTCB_YSTATUS_MASK_0xf                      ((readDtcSubFunction)0x0f)
#define REPORT_NUMBER_OF_MIRROR_MEMORY_DTC_BY_STATUS_MASK_0x11          ((readDtcSubFunction)0x11)
#define REPORT_NUMBER_OF_EMISSIONS_OBD_DTC_BY_STATUS_MASK_0x12          ((readDtcSubFunction)0x12)
#define REPORT_EMISSIONS_OBD_DTC_BY_STATUS_MASK_0x13                    ((readDtcSubFunction)0x13)
#define REPOR_TDTC_SNAPSHOT_IDENTIFICATION_0x03                         ((readDtcSubFunction)0x03)
#define REPORT_DTC_SNAPSHOT_RECORD_BY_DTC_NUMBER_0x04                   ((readDtcSubFunction)0x04)
#define REPORT_DTC_STORED_DATA_BY_RECORD_NUMBER_0x05                    ((readDtcSubFunction)0x05)
#define REPORT_DTC_EXT_DATA_RECORD_BY_DTC_NUMBER_0x06                   ((readDtcSubFunction)0x06)
#define REPORT_MIRROR_MEMORY_DTC_EXT_DATA_RECORD_BY_DTC_NUMBER_0x10     ((readDtcSubFunction)0x10)
#define REPORT_NUMBER_OF_DTC_BY_SEVERITY_MASK_RECORD_0x07               ((readDtcSubFunction)0x07)
#define REPORT_DTC_BY_SEVERITY_MASK_RECORD_0x08                         ((readDtcSubFunction)0x08)
#define REPORT_SEVERITY_INFORMATION_OF_DTC_0x09                         ((readDtcSubFunction)0x09)
#define REPORT_SUPPORTED_DTC_0x0A                                       ((readDtcSubFunction)0x0A)
#define REPORT_FIRST_TEST_FAILED_DTC_0x0B                               ((readDtcSubFunction)0x0B)
#define REPORT_FIRST_CONFIRMED_DTC_0x0C                                 ((readDtcSubFunction)0x0C)
#define REPORT_MOST_RECENT_TEST_FAILED_DTC_0x0D                         ((readDtcSubFunction)0x0D)
#define REPORT_MOST_RECENT_CONFIRMED_DTC_0x0E                           ((readDtcSubFunction)0x0E)
#define REPORT_DTC_FAULT_DETECTION_COUNTER_0x14                         ((readDtcSubFunction)0x14)
#define REPORT_DTC_WITH_PERMANENT_STATUS_0x15                           ((readDtcSubFunction)0x15)
#define REPORT_DTC_EXT_DATA_RECORD_BY_RECORD_NUMBER_0x16                ((readDtcSubFunction)0x16)
#define REPORT_USER_DEF_MEMORY_DTC_BY_STATUS_MASK_0x17                  ((readDtcSubFunction)0x17)
#define REPORT_USER_DEF_MEMORY_DTC_SNAPSHOT_RECORD_BY_DTC_NUMBER_0x18   ((readDtcSubFunction)0x18)
#define REPORT_USER_DEF_MEMORY_DTC_EXT_DATA_RECORD_BY_DTC_NUMBER_0x19   ((readDtcSubFunction)0x19)
#define REPORT_WWHOBD_DTC_BY_MASK_RECORD_0x42                           ((readDtcSubFunction)0x42)
#define REPORT_WWHOBD_DTC_WITH_PERMANENT_STATUS_0x55                    ((readDtcSubFunction)0x55)
