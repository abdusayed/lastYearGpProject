...
static void DslSendNRC(Dcm_NegativeResponseCodeType NRC)
{
  ...
  if( DCM_NOT_IN_USE == Glb_DslProtocolRunTimePtr->NegativeResponseBuffer->BufferCurrentUse)
  {
      ...
      //TODO
      const Can_PduType Can_PduTypeobj =
      {
       .id = Glb_DslProtocolRunTimePtr->DCM_TxBufferInfo->diagResponseTxPduId ,
       .sdu = Glb_DslProtocolRunTimePtr->NegativeResponseBuffer->NRInfo->SduDataPtr ,
       .length =  Glb_DslProtocolRunTimePtr->NegativeResponseBuffer->NRInfo->SduLength ,
      };
      ...
      //PduR_DcmTransmitResult =  Can_write(0xFFFF,&Can_PduTypeobj) ;
      ...
      break;
        ...
        case DCM_DSD_PENDING_RESPONSE_SIGNALED:
            ...
            //TODO
              ...
              {
               .id  = Glb_DslProtocolRunTimePtr->DCM_TxBufferInfo->diagResponseTxPduId,
               .sdu = Glb_DslProtocolRunTimePtr->DCM_TxBufferInfo->dcmTxBuffer.SduDataPtr ,
               .length =  Glb_DslProtocolRunTimePtr->DCM_TxBufferInfo->dcmTxBuffer.SduLength ,
              };
